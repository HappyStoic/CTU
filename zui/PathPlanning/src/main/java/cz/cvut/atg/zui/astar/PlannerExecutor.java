...
public class PlannerExecutor {
    ...
    public static final String DATA_FILE = "src/main/resources/ukhigh_filtered.dat";
...
//        GraphNode origin = newroadGraph.getNodeByNodeId(29367535);
//        GraphNode destination = newroadGraph.getNodeByNodeId(21099171);
//        GraphNode origin = newroadGraph.getNodeByNodeId(13891858);
//        GraphNode destination = newroadGraph.getNodeByNodeId(688820892);
